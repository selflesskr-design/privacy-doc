...
const FAQ = {
  upload: {
    q: '파일이 서버에 올라가나요?',
    a: '올라가지 않습니다. 이 서비스는 파일을 내 브라우저 안에서 직접 처리합니다. 방문 통계를 위한 요청은 있지만 파일과는 무관하며, 파일을 보낼 수 있는 통로 자체가 브라우저 보안 설정으로 막혀 있습니다. 개발자도구의 네트워크 탭에서 직접 확인할 수 있습니다.',
  },
  free: {
    q: '무료인가요? 가입해야 하나요?',
...
const TRUST_PAGES = [
  ...
  },
  {
    ...
    schema: 'WebPage',
    sections: [
      { t: 'p', text: '이 서비스는 이용자의 파일을 수집하지 않습니다. 수집할 수 있는 구조가 아닙니다.' },
      { t: 'h2', text: '수집하지 않는 것' },
      {
        t: 'ul',
        items: [
      ...
      { t: 'h2', text: '외부 전송' },
      {
        t: 'p',
        text:
          '브라우저 보안 설정으로 통신 가능한 곳을 우리 서버와 구글 애널리틱스로만 제한해 두었습니다. 그 밖의 어디로도 요청을 보낼 수 없고, 파일은 그 두 곳 어느 쪽으로도 가지 않습니다. 개발자도구의 네트워크 탭에서 직접 확인할 수 있습니다.',
      },
      { t: 'h2', text: '제3자 제공' },
