...
const TOOL_PAGES = [
  ...
  toolPage({
    ...
    title: `사진 위치정보 삭제 — GPS·EXIF 정보 지우기 | ${BRAND}`,
    description:
      '사진에 남아 있는 촬영 위치와 촬영 시각, 기기 정보를 지웁니다. 화질은 그대로 유지되고, 파일은 내 브라우저에서만 처리됩니다.',
    h1: '사진 정보 삭제',
    lead:
      '사진 파일에는 찍은 장소와 기기 정보가 함께 저장됩니다. 사진을 다시 저장하면서 이 기록만 지웁니다. 보이는 그림은 그대로입니다.',
    ready: true,
...
const TRUST_PAGES = [
  ...
  },
  {
    ...
    schema: 'WebPage',
    sections: [
      { t: 'p', text: `${BRAND}는 이용자의 파일과 개인정보를 수집하지 않습니다. 수집할 수 있는 구조가 아닙니다.` },
      { t: 'h2', text: '수집하지 않는 것' },
      {
        t: 'ul',
        items: [
          ...
          '접속 기록, 사용 통계, 행동 분석 — 분석 도구를 쓰지 않습니다',
          '광고나 추적을 위한 쿠키',
        ],
      },
      { t: 'h2', text: '기기에 저장되는 것' },
      ...
      { t: 'h2', text: '외부 전송' },
      {
        t: 'p',
        text:
          '사용 중에 밖으로 나가는 통신이 없습니다. 브라우저 보안 설정으로 막혀 있고, 개발자도구에서 직접 볼 수 있습니다.',
      },
      { t: 'h2', text: '제3자 제공' },
