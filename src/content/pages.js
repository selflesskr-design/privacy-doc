...
const HOME = {
  ...
  sections: [
    ...
    // 홈에서 나가는 링크는 위 두 버튼뿐이었고, 둘 다 `noindex, nofollow`인
    // 편집기입니다. 자바스크립트를 돌리지 않는 크롤러에게 홈이 막다른 길이었고,
    // 푸터는 프리렌더에 들어가지 않습니다. 이 한 줄이 나머지 전부로 가는 길입니다.
    { t: 'actions', items: [{ label: '모든 도구 보기', href: '/tools' }] },
  ],
}
