...
const TRUST_PAGES = [
  ...
  },
  {
    ...
    sections: [
      ...
      { t: 'h2', text: '4. 외부 서비스와 국외 처리' },
      {
        t: 'p',
        text:
          'Google LLC는 방문·기기 정보를 이용 통계 분석 목적으로, Vercel Inc.는 접속·기기·보안 정보를 웹사이트 호스팅과 콘텐츠 전송 목적으로 국외에서 처리할 수 있습니다. 정보는 서비스 접속 시 암호화된 네트워크를 통해 전송되며 각 제공업체의 설정과 정책에 따른 기간 동안 보관됩니다.',
      },
      ...
      { t: 'h2', text: '6. 보유·파기 및 이용자 권리' },
      { t: 'p', text: '분석정보와 호스팅 로그는 각 제공업체의 설정과 정책에 따른 기간 동안 보관된 후 삭제됩니다. 이용자는 브라우저의 쿠키와 사이트 데이터를 삭제하거나 Google Analytics 차단 도구를 사용할 수 있으며, 열람·정정·삭제·처리정지는 이메일로 요청할 수 있습니다.' },
      { t: 'h2', text: '7. 안전성 확보 조치' },
      { t: 'p', text: '전송구간 암호화(HTTPS), 콘텐츠 보안 정책, 통신 대상 제한과 파일의 브라우저 내 처리를 적용합니다.' },
      { t: 'h2', text: '8. 운영 주체와 문의' },
      { t: 'ul', items: ['서비스명: Privacy', '운영 주체: Unique Lab(유니크랩)', '시행일: 2026년 8월 4일'] },
